<template>
    <div class="customer">
        <div class="bg-fff mt10">
            ...
            <comInput @getClickItems="selectCustomer" paramkey="string2" :type="7" title="客户姓名" :textRight="false" placeholder="请选择" :value="params.string2"></comInput>
            <comInput @getInputVal="setValue" paramkey="string3" :type="0" title="购买产品" :textRight="false" :value="params.string3"></comInput>
            <comInput @getInputVal="setValue" paramkey="string4" :type="1" title="产品期限" :textRight="false" value=""></comInput>
            <comInput @getInputVal="setValue" paramkey="number3" :type="1" title="认购金额" :textRight="false" value="2千万"></comInput>
            <comInput @getInputVal="setValue" paramkey="date4" :type="3" title="出资认缴日" :textRight="false" :value="params.data4"></comInput>
            ...
            <comInput @getInputVal="setValue" paramkey="string11" :type="1" title="本次提奖" :textRight="false" value=""></comInput>
...
export default {
  ...
  onShow () {
    ...
    if (has) {
      ...
      this.params['string6'] = info['string1'] // 业绩单号
      this.params['string8'] = info['string2'] // 提成方式
      this.params['string2'] = info['FName'] // 客户姓名
  ...
  methods: {
    ...
    sure () {
      ...
      this.$api.creatRoyaltyList(data)
        .then(res => {
          if (res.Msg === '操作成功') {
            // mpvue.
  ...
  created () {
    ...
    this.params['date4'] = this.getDate()
  }
}
</script>
