<template>
  <div class="main">
    ...
    <div class="booking" v-if="step === 1">
      <div class="line-bar">
        <van-button type="info">财务信息</van-button>
      </div>
      <div class="block">
        <div class="from">
          <div class="line">
      ...
      <div class="block">
        <div class="from">
          ...
          <div class="line required">
            ...
            <div class="val">
              <input type="text" placeholder="请输入其收益分配账户" placeholder-class="cgey">
            </div>
          </div>
          <div class="line required">
            <div class="key">收益分配账户开户行</div>
            <div class="val">
              <input type="text" placeholder="请输入分配账户开户行" placeholder-class="cgey">
            </div>
          </div>
    ...
    <div class="line-bar">
      ...
      <van-button type="info" @click="setStep(1)">下一步</van-button>
