      ...
      <div class="block">
        ...
        <div class="from">
          ...
          <div class="line auto">
            ...
            <div class="val ta-r">
              <div class="img-item">
                <img class="img" src="../../../img/status_using.png" mode="aspectFill">
    ...
    <div class="booking">
      <div class="block">
        <div class="title flex">
          ...
          <div style="padding-top: 4px"><van-switch :checked="false" @change="changeSwitch" /></div>
        </div>
        <div class="from">
          <div class="line">
