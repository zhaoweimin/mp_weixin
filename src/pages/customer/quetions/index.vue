      ...
      <div class="input-question">
        <div class="flex">
          ...
          <div class="val flex-1">
            <input type="text" placeholder="请输入用户姓名" placeholder-class="cplaceholder">
          </div>
        </div>
        ...
        <div class="flex">
          ...
          <div class="val flex-1">
            <input type="text" placeholder="请输入身份号码" placeholder-class="cplaceholder">
          </div>
        </div>
      </div>
      <question v-for="(vo, key) in questions" :key="key" :data="vo" :sort="vo.num" :sign="vo.sign" @change="change"></question>
    </div>
